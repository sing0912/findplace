...
│   └── tdd.md
│
├── test-scenario/           # 테스트 시나리오 미들웨어
│   ├── README.md
│   ├── scenario-definition.md
│   └── domains/
│
│── # 구현 완료 도메인 지침 (루트 레벨)
├── region-domain.md         # 지역/행정구역
├── pet-domain.md            # 반려동물
├── funeral-home-domain.md   # 장례식장
├── coupon-domain.md         # 쿠폰
├── location-service.md      # 위치 기반 서비스
├── admin-user-management.md # 관리자 사용자 관리
├── batch-jobs.md            # 배치 작업
├── monitoring.md            # 모니터링
├── mypage.md                # 마이페이지
│
...
| auth | ✅ | ✅ | ⬜ | ⬜ |
| user | ✅ | ✅ | ✅ | ⬜ |
| region | ✅ region-domain.md | ✅ | ⬜ | ⬜ |
| pet | ✅ pet-domain.md | ✅ | ✅ | ⬜ |
| funeralhome | ✅ funeral-home-domain.md | ✅ | ✅ | ⬜ |
| coupon | ✅ coupon-domain.md | ✅ | ⬜ | ⬜ |
| location | ✅ location-service.md | ✅ | ✅ | ⬜ |
| admin | ✅ admin-user-management.md | ✅ | ⬜ | ⬜ |
| batch | ✅ batch-jobs.md | ✅ | ⬜ | ⬜ |
