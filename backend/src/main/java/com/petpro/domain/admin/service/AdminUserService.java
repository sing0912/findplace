package com.petpro.domain.admin.service;

import com.petpro.domain.admin.dto.*;
...
import com.petpro.domain.log.service.AdminActionLogService;
...
public class AdminUserService {
    ...
    public AdminUserResponse changeStatus(Long userId, StatusChangeRequest request, Long adminId) {
        ...
        // MySQL 로그 DB에 비동기 저장
        adminActionLogService.logAdminAction(AdminActionLogRequest.builder()
                .adminId(adminId)
                .actionType(AdminActionType.USER_STATUS_CHANGE)
                .targetType(TargetType.USER)
                .targetId(userId)
                .description(String.format("%s → %s: %s", previousStatus, request.getStatus(), request.getReason()))
                .build());
    ...
    public AdminUserResponse changeRole(Long userId, RoleChangeRequest request, Long adminId) {
        ...
        adminActionLogService.logAdminAction(AdminActionLogRequest.builder()
                ...
                .targetType(TargetType.USER)
                .targetId(userId)
                .description(String.format("%s → %s: %s", previousRole, request.getRole(), request.getReason()))
                .build());
